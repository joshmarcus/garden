...
Have the retro run garden metrics and garden operator-spend against phase 03 and paste the numbers into the closing document before the close verdict.

## Context

Raised by the project-manager persona review (definition of done). persona:project-manager:context-garden/phase-04.
