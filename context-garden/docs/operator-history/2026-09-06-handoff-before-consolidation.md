# Archived operator handoffs — historical, not current instructions

Superseded on 2026-09-06. Read root AGENTS.md for current operating state. This archive contains contradictory historical settings and must not be used as an action queue.
...
- The tool is installed in `.venv` from a pinned commit of https://github.com/joshmarcus/context-garden (currently b72dbcc);
